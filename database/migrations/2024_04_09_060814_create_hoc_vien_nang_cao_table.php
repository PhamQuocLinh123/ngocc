...
return new class extends Migration
{
    ...
    {
        Schema::create('hoc_vien_nang_cao', function (Blueprint $table) {
            $table->id();
            $table->foreignId('hoc_vien_id')->constrained('hoc_vien'); // Thêm ràng buộc khóa ngoại
    ...
    {
        Schema::dropIfExists('hoc_vien_nang_cao');
    }
};
